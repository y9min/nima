...
struct AppCluster: View {
    ...
    private func appIconView(index: Int, center: CGPoint, geometry: GeometryProxy) -> some View {
        ...
        .overlay(
            Circle()
                .strokeBorder(isToggleEnabled ? NimaColors.skyBlue : Color.white.opacity(0.35), lineWidth: isToggleEnabled ? 5 : 1)
        )
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack {
                    ...
                    .padding(.leading, NimaSpacing.xl + 10)
                    .padding(.bottom, 14)
...
struct CenterIconWithDrag: View {
    ...
    var body: some View {
        ...
        .accessibilityElement(children: .ignore)
        .accessibilityIdentifier("nima.app.center.\(app.id)")
        .accessibilityLabel(app.name)
        .accessibilityAddTraits(.isButton)
        .offset(dragOffset)
        .position(x: center.x, y: center.y - 75)
