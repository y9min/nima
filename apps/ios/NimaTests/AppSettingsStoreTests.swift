...
final class AppSettingsStoreTests: XCTestCase {
    ...
    func testBlankDisplayNameClearsLocalOverrideAndPreservesDefaultFallback() {
        ...
        defaults.set("Nima", forKey: NimaConstants.displayNameKey)
        ...
        XCTAssertNil(defaults.string(forKey: NimaConstants.displayNameKey))
        XCTAssertEqual(
    ...
    func testAdvancedResetRestoresTunnelDefaultsOnly() {
        let defaults = testDefaults()
        defaults.set(false, forKey: NimaConstants.udpSelectiveSafeModeEnabledKey)
        defaults.set(true, forKey: NimaConstants.udpDisabledFastRejectEnabledKey)
        defaults.set(
        ...
        XCTAssertTrue(defaults.bool(forKey: NimaConstants.udpSelectiveSafeModeEnabledKey))
        XCTAssertFalse(defaults.bool(forKey: NimaConstants.udpDisabledFastRejectEnabledKey))
        XCTAssertEqual(
            defaults.string(forKey: NimaConstants.tun2socksStartupModeKey),
